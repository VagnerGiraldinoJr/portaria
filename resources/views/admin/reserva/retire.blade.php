            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{ Form::open(['route' => [$params['main_route'] . '.retire', $reserva->id], 'method' => 'PUT']) }}
                        <div class="row">
                            <div id="div_data_saida" class="form-group col-6 col-md-6 col-lg-6">
                                {{ Form::label('dt_entrega_chaves', 'Data e Hora da retirada das chaves:') }}
                                {{ Form::text('dt_entrega_chaves', \Carbon\Carbon::now()->format('d-m-Y H:i:s'), ['class' => 'form-control', 'placeholder' => 'Informe a data da Saída na unidade']) }}
                            </div>
                            <div class="form-group col-6 col-md-6 col-lg-6">
                                <label for="retirado_por">Registre o nome de quem está retirando as chaves:</label>
