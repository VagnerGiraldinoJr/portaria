            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {{ Form::open(['route' => [$params['main_route'] . '.return', $reserva->id], 'method' => 'PUT']) }}

                        <div class="row">
                            <div id="div_data_saida" class="form-group col-6 col-md-6 col-lg-6">
                                {{ Form::label('dt_devolucao_chaves', 'Data Devolução:') }}
                                {{ Form::text('dt_devolucao_chaves', \Carbon\Carbon::now()->format('d-m-Y H:i:s'), ['class' => 'form-control', 'placeholder' => 'Informe o data da devolução das chaves']) }}
                            </div>

                            <div class="form-group col-6 col-md-6 col-lg-6">
                                <label for="devolvido_por">Devolvido por:</label>
                                <input type="text" name="devolvido_por" id="devolvido_por" class="form-control" required>
                            </div>
                        </div>
